      ...
      <div className="main-wrapper">
        ...
        <main className="content-part-wrapper ">
          <div className="animate__animated animate__fadeInUp animate__faster">
            ...
            <div className="mt-4 d-flex justify-content-between">
              <div className="">
                <h1 className="main-heading m-0">Staff Members </h1>
              </div>
                    ...
                    {/* <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                                    ...
                                    <li class="dropdown-item">
                                        <div class="form-design border p-2">
                                            ...
                                            <div class="mt-2">
                                                <button class="comman-btn w-100">Filter by Date Range</button>
                                            </div>
                                        </div>
                                    </li>
                                </ul> */}
        ...
        <div className="tabs">
          ...
          <a
            ...
            className={userType === "Pending" ? "tab-item active" : "tab-item "}
          >
            Pending Requests
          </a>
          <a
